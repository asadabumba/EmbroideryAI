...
Full dataset:
Sources complete: 118 / 717
Variants verified: 2,950 / 17,925
Percent: 16.46%

Current source:
next: raw/13 let vmeste.EMB

Retries:
4 source retry attempts; 1 task retry
...
Current action:
run and verify production chunk 13 (sources 121-130)
