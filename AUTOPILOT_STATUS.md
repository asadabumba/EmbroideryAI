...
Full dataset:
Sources complete: 188 / 717
Variants verified: 4,700 / 17,925
Percent: 26.22%

Current source:
next: raw/8.6Mishka v kalyaske.EMB

Retries:
12 source retry attempts; 5 task retries
...
Current action:
run and verify production chunk 20 (sources 191-200)
